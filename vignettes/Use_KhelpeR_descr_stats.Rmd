...
```{r}
KhelpeR::kable_table(KhelpeR::fastNumStats(dataset))
```
...
```{r}
KhelpeR::kable_table(KhelpeR::stats_table(dataset, group_var = "gear", method = "base"))
```

#### Extensive Numeric Statistics per Category

```{r}
KhelpeR::kable_table(KhelpeR::stats_tablePerCat(dataset, "mpg", "gear"))
```
