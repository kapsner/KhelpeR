...
```{r}
KhelpeR::kableTable(KhelpeR::stats_table(dataset, group_var = "gear", method = "base"))
```

#### Extensive Numeric Statistics per Category

```{r}
KhelpeR::kableTable(KhelpeR::stats_tablePerCat(dataset, "mpg", "gear"))
```
